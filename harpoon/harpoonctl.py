...
smtphost =  input("SMTP host: [ie. Development and implementation of a facial recognition intrusion detection systemsmtp.gmail.com]: ")
...
def main():
    ...
    for name, email in zip(names, emails):
        ...
        message = message_template.substitute(PERSON_NAME=name.title(), DOMAIN=domain)
